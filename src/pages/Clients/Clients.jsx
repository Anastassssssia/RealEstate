...
import DataClients from './DataClients.json'
                      ...
                      <table className='table'>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><input className='input_search' name="name_client" type="search" value={searchQuery.name_client} onChange={handleSearch} /></td>
